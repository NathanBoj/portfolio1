    ...
    return (
        <nav className="bg-gray-900 bg-opacity-75 backdrop-blur-sm text-white py-4 px-8 flex justify-between items-center fixed top-0 w-full z-50">
            ...
            <button
                ...
                className="hover:opacity-70 mr-4 mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
