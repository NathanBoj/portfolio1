...
function Navbar() {
    ...
    return (
        <nav className="bg-black bg-opacity-60 backdrop-blur-lg text-white py-4 px-8 flex justify-between items-center fixed top-0 w-full z-50 border-b-4 border-orange-500">
            ...
            <button
                type="button"
                onClick={() => window.open(`mailto:bojczuk.nathan@gmail.com`, '_blank')}
                data-te-ripple-init
                data-te-ripple-color="light"
                className="bg-green-600 hidden md:inline-block hover:opacity-70 mr-4 mb-2 rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                >
